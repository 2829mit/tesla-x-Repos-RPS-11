        ...
        <div className="px-6 md:px-10 h-full">
          <div className="relative flex items-center justify-between h-full">
            ...
            <div className="flex items-center">
              <nav className="hidden md:flex items-center text-sm font-semibold text-gray-600 tracking-wider space-x-8">
                {navItems.map(item => (
                  <button 
                    key={item} 
                    onClick={() => handleNavClick(item)}
                    className="py-2 hover:text-black transition-colors uppercase bg-transparent border-none cursor-pointer"
                  >
                    {item}
                  </button>
                ))}
            ...
            >
              <img
                ...
                alt="Repos logo"
                className="h-8 md:h-9 w-auto opacity-80 hover:opacity-100 transition-opacity"
              />
            </div>
            ...
            <div className="flex items-center justify-end">
              ...
              <div className="hidden md:flex items-center space-x-8 text-sm font-semibold text-gray-600 tracking-wider">
